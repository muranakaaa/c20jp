...
「クリック２０世紀」は20年以上前に公開され、5年ほど前に閉鎖された個人サイトです。本リポジトリは、誰でも参照できる Internet Archive（Wayback Machine）の保存データをもとに、失われたコンテンツを残すことだけを目的とした非営利の復元です。広告や課金は一切なく、収益化はしていません。

原作者への連絡も試みましたが、公開されていた連絡先はすでに使われておらず、到達できていません。原作者・権利者の方で、掲載の停止や修正のご希望があれば、[@ayatakaa_chan](https://x.com/ayatakaa_chan) までご連絡ください。速やかに対応します。
